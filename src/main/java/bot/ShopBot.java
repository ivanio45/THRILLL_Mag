...
public class ShopBot extends TelegramLongPollingBot {
    ...
    public String getBotToken() {
        return "7335356805:AAHxxc5ZM3K7aPCDGiU1sT_ra9m88tY2fAk";
    }
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            switch (messageText.toLowerCase()) {
                ...
                case "перейти к оплате\uD83D\uDCB5":
                    sendMessageWithText(chatId, "Мы принимаем способ оплаты переводом\uD83D\uDCB3 \nДля совершения оплаты напишите продавцу  в Вконтакте и прикрепите к сообщению скриншот корзины: [Санёк\uD83D\uDC64](https://vk.com/im?sel=292529117)" +
                            "\nНо также оформить и оплатить заказ можно через ВК магазин: [VK Маркет](https://vk.com/market-215533820)");
                    break;
                default:
                    try {
